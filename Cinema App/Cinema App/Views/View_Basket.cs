...
namespace Cinema_App
{
    class View_Basket : View
    {
        ...
        public override void Render()
        {
            ...
            Menu basketMenu = new Menu(Controller, Strings.Basket, $"{Strings.Total}: €{String.Format("{0:N}", Basket.TotalPrice())}");
            ...
            {
                basketMenu.AddMenuOption(Strings.Checkout, (x) => { Controller.SwitchView(new View_Checkout(Controller, Strings.Checkout)); }, null);
            }
