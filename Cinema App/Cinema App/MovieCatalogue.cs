...
{
    class MovieCatalogue : View
    {
        public MovieCatalogue(Controller controller, string title, string subTitle = "", int permLevel = 0)
        ...
        void Movie()
        {
            ...
            MovieInformation mi = new MovieInformation(Controller, "Honest Thief", this, movie);
        ...
        void Movie2()
        {
            ...
            MovieInformation mi = new MovieInformation(Controller, "The War With Grandpa", this, movie);
        ...
        void Movie3()
        {
            ...
            MovieInformation mi = new MovieInformation(Controller, "The Dark and the Wicked", this, movie);
        ...
        void Movie4()
        {
            ...
            MovieInformation mi = new MovieInformation(Controller, "Bigfoot Family", this, movie);
        ...
        void Movie5()
        {
            ...
            MovieInformation mi = new MovieInformation(Controller, "Fatman", this, movie);
