...
namespace Cinema_App
{
    abstract class View
    {
        ...
        public void DrawTitleBar()
        {
            ...
            Console.ForegroundColor = (Controller.CurrentUser != null && Controller.CurrentUser.Permlevel == Program.ADMIN_PERM_LEVEL) ? ConsoleColor.DarkYellow : ConsoleColor.Yellow;
